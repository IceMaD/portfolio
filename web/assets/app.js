...
module.exports = [
  'WordFormatter', 'TerminalState', function(word, terminal) {
    var alias, colors, commands, me;
    me = {
      firstName: 'Marc',
      name: 'Duboc',
      pseudo: 'icemad',
    ...
    alias = function(name) {
      return {
        exec: function() {
          return commands[name].exec.apply(name, arguments);
        },
    ...
    commands = {
      man: {
        exec: function(command) {
          if ((command != null) && (commands[command] == null)) {
            return word('warning')('Unknown command "' + word('emphasis')(command) + '" !');
          }
          if (command != null) {
            return word('info')(commands[command][commands[command].man ? 'man' : 'help']);
          }
          return word('text')('Pass a command name, or try ' + word('info')('list') + ' command');
        },
        help: 'Some help about a command',
        man: "Take one argument, the command name.\n\nDisplay informations about how to use a given command\n\nExample: " + (word('emphasis')('man name'))
      },
      help: alias('man'),
      list: {
        exec: function() {
          var command, commandList, name;
          commandList = [];
          for (name in commands) {
            command = commands[name];
            if (command.help) {
              commandList.push(word('text')(name + ': ' + word('info')(command.help)));
            }
          }
      ...
      pseudo: {
        exec: function() {
          return [word('info')(' _____         __  __       _____'), word('info')('|_   _|       |  \\/  |     |  __ \\'), word('info')('  | |  ___ ___| \\  / | __ _| |  | |'), word('info')('  | | / __/ _ \\ |\\/| |/ _` | |  | |'), word('info')(' _| || (_|  __/ |  | | (_| | |__| |'), word('info')('|_____\\___\\___|_|  |_|\\__,_|_____/')];
        },
        help: 'Tell you my pseudo'
      },
      julien: {
        exec: function() {
          return [word('smell')('░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░'), word('smell')('░░░░░░░░░░░░░░░▓████████▓░░░░░░░░░░░░░░░░'), word('smell')('░░░░░░░░░░░░░░▒█████████▓▒░░░░░░░░░░░░░░░'), word('smell')('░░░░░░░░░░░░░░░▓██▓▓▓▓▓▓███░░░░░░░░░░░░░░'), word('smell')('░░░░░░░░░░░░░░░▓██▓▓▓▓▓▓▓██▓░░░░░░░░░░░░░'), word('smell')('░░░░░░░░░░░░░░░░▓█▓▓▓▓▓▓▓▓█▓░░░░░░░░░░░░░'), word('smell')('░░░░░░░░░░░░░░░░▓█▓▓▓▓▓▓▓▓█▓▒░░░░░░░░░░░░'), word('smell')('░░░░░░░░░░░░░░░▓██▓▓▓▓▓▓▓▓▓▓▓░░░░░░░░░░░░'), word('smell')('░░░░░░░░░░░▒▓▓█████▓▓▓▓▓▓▓▓██▓░░░░░░░░░░░'), word('smell')('░░░░░░░░░▓█████████▓▓▓▓▓▓▓▓███▓▒░░░░░░░░░'), word('smell')('░░░░░░░░▓███▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓████▓░░░░░░░░'), word('smell')('░░░░░░▒████▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓███▓░░░░░░░'), word('smell')('░░░░░░▓██▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓██▓░░░░░░'), word('smell')('░░░░░░▓██▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓██▓░░░░░░'), word('smell')('░░░░░░███▓▓▓█████▓▓▓▓▓▓▓█████▓▓▓██▓░░░░░░'), word('smell')('░░░░░░████▓█▓░░▒▓▓▓▓█▓██▓░░▒▓█▓███▓░░░░░░'), word('smell')('░░░░░▒█████▓░░░░▒▓█████▓░░░░▒▓█████▒░░░░░'), word('smell')('░░░░▓████▓▒░░▒█░░░▓███▒░░▒▓░░░▓█████▓░░░░'), word('smell')('░░▒▓███▓▓▓░░░██▒░░▒▓█▓░░░▓█▓░░░▓▓▓███▓▒░░'), word('smell')('░▓████▓▓▓▓▓░░░░░░░▓▓▓▓▒░░░░░░░▓▓▓▓▓████░░'), word('smell')('░███▓▓▓▓▓▓▓▓▒░░░▓▓▓▓▓▓▓▓▒░░░▓▓▓▓▓▓▓▓▓██▓░'), word('smell')('░███▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓██▓░'), word('smell')('░███▓▓▓▓▓░▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓░▓▓▓▓██▓░'), word('smell')('░███▓▓▓▓▓░░▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓░░▓▓▓▓██▓░'), word('smell')('░███▓▓▓▓▓▓░░░▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓░░░▓▓▓▓▓██▓░'), word('smell')('░█████▓▓▓▓▓▓▓░░░░░░░░░░░░░░░░▓▓▓▓▓▓▓███▒░'), word('smell')('░▒█████▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓███▓█░░'), word('smell')('░░░▓████▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓▓████▒░░░'), word('smell')('░░░░▒▓█████████████████████████████▓▒░░░░'), word('smell')('░░░░░▒▓███████████████████████████▓░░░░░░')];
        }
      },
      details: {
        exec: function() {
      ...
      demo: {
        exec: function() {
          return [word('data')('Example of data line'), word('warning')('Example of warning line'), word('emphasis')('Example of emphasis line'), word('error')('Example of error line'), word('info')('Example of info line'), word('smell')('Example of smell line'), word('success')('Example of success line')];
        }
      },
      theme: {
        exec: function(color) {
          if (!(colors.indexOf(color) >= 0)) {
            return word('error')('Unknown theme "' + word('emphasis')(color) + '" !');
          }
          if (color === terminal.color) {
            return word('warning')('Already on the ' + terminal.color + ' theme');
          }
          terminal.color = color;
          return word('info')('Color changed to theme ' + terminal.color + ' !');
        },
      ...
      name: {
        exec: function() {
          return [word('info')(me.firstName + ' ' + me.name)];
        },
        help: 'Tell you my name'
      },
      whoami: {
        exec: function() {
          return [word('info')(me.pseudo)];
        },
        help: 'Tell you my username'
      },
      job: {
        exec: function() {
          return [word('info')(me.job)];
        },
...
module.exports = [
  'PromptHistory', 'WordFormatter', 'Commands', function(history, word, commands) {
    var errors, help, unknown;
    errors = 0;
    help = function() {
      return word('text')('Try ' + word('info')('list') + ' command');
    };
    unknown = function(prompt) {
      return [word('error')('Command not found "' + word('emphasis')(prompt) + '" !')];
    };
    return {
      handle: function(prompt, success) {
        var cleanPrompt, command, params, response;
        if (prompt === 'basic-tuto') {
          return success([help()]);
        }
        ...
        if (commands[command] != null) {
          errors = 0;
          return success(response.concat(commands[command].exec.apply(command, params)).concat(word('text')));
        } else {
          errors++;
          response = response.concat(unknown(command)).concat(word('text'));
          if (errors % 3 === 0) {
            return success(response.concat(help()));
          }
  ...
  function() {
    return {
      ...
      push: function(prompt) {
        if (this.list[0] !== prompt) {
          this.list.unshift(prompt);
        }
        return this;
      },
      getCurrent: function() {
      ...
      getPrevious: function() {
        if (this.current < this.list.length - 1 && this.enabled) {
          this.current += 1;
        }
        this.enabled = true;
...
module.exports = [
  'LineManager', 'PromptHistory', 'TerminalState', '$timeout', function(Line, PromptHistory, state, $timeout) {
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        selectPrompt = function() {
          return $timeout(function() {
            if (scope.prompt) {
              return input.setSelectionRange(scope.prompt.length, scope.prompt.length);
            }
          });
        };
        $timeout(function() {
          if (scope.lines.length || scope.prompt) {
            return false;
          }
          return Line.handle('basic-tuto', function(lines) {
            var i, len, line;
        ...
        scope.onKeyDown = function(event) {
          switch (event.which) {
            case 38:
              scope.prompt = PromptHistory.getPrevious();
              selectPrompt();
              break;
            case 40:
              scope.prompt = PromptHistory.getNext();
              selectPrompt();
          }
        ...
        return scope.submit = function() {
          ...
          return Line.handle(scope.prompt, function(lines) {
            var i, len, line;
            for (i = 0, len = lines.length; i < len; i++) {
              line = lines[i];
              scope.lines.push(line);
      ...
      switch (type) {
        case 'link':
          return function(url, name) {
            ...
            return new Text('<a href="' + url + '" target="_blank" class="terminal_word --link">' + name + '</a>');
          };
        case 'dump':
